...
def create_analysis_graph():
    ...
    builder.add_node("technical_analysis", run_technical_analysis)
    builder.add_node("price_action", run_price_action)
    builder.add_node("candlestick", run_candlestick)
    builder.add_node("support_resistance", run_support_resistance)
    builder.add_node("smc", run_smc)
    builder.add_node("elliott_wave", run_elliott_wave)
    builder.add_node("wyckoff", run_wyckoff)
    builder.add_node("news", run_news)
    builder.add_node("cross_validate", run_cross_validate)
    builder.add_node("historical_similarity", run_historical_similarity)
    builder.add_node("risk_analysis", run_risk_analysis)
    builder.add_node("learning", run_learning_agent)
    builder.add_node("reasoning", run_reasoning_agent)
    builder.add_node("save_recommendation", run_save_recommendation)
